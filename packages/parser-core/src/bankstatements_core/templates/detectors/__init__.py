...
from bankstatements_core.templates.detectors.card_number_detector import CardNumberDetector
from bankstatements_core.templates.detectors.column_header_detector import ColumnHeaderDetector
...
from bankstatements_core.templates.detectors.loan_reference_detector import LoanReferenceDetector
